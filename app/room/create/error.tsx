...
export default function CreateRoomError({
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4">
      ...
      >
        <h2 className="text-2xl font-bold text-white mb-4">Create Room Error</h2>
        <p className="text-zinc-400 mb-6">
          We encountered an issue creating a new room. Please try again or return to the home page.
        </p>
