...
export default function ResetPasswordError({
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4">
      ...
      >
        <h2 className="text-2xl font-bold text-white mb-4">Password Reset Error</h2>
        <p className="text-zinc-400 mb-6">
          We encountered an issue while processing your password reset request. Please try again.
        </p>
